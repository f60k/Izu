...
(function () {
  $(function () {
    ...
    if (vars.jump !== null) {
      ...
      if (index === 0) {
        return $('.category-list .activity').click();
      } else if (index === 1) {
        return $('.category-list .life').click();
      } else if (index === 2) {
        return $('.category-list .culture').click();
      } else if (index === 3) {
        return $('.category-list .event').click();
      } else if (index === 4) {
        return $('.category-list .sns').click();
      }
    }
